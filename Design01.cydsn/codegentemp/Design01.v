...
module ADC_DelSig_v3_30_2 (
	...
	cy_clock_v1_0
		#(.id("17f15bd9-20d2-4267-925f-2fc3b5a12c75/b7604721-db56-4477-98c2-8fae77869066"),
	...
	cy_clock_v1_0
		#(.id("17f15bd9-20d2-4267-925f-2fc3b5a12c75/edd15f43-b66b-457b-be3a-5342345270c8"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
...
module top ;
	...
	cy_clock_v1_0
		#(.id("1ec388cf-aa7b-4ee3-aaf4-d7b1397158ef"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("100000000000"),
		  .is_direct(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("29e37f2d-ef1d-45f2-9a8f-4858eea262ee"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__DIRECCION_net;
	wire [0:0] tmpIO_0__DIRECCION_net;
	wire [0:0] tmpINTERRUPT_0__DIRECCION_net;
	electrical [0:0] tmpSIOVREF__DIRECCION_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		DIRECCION
		 (.oe(tmpOE__DIRECCION_net),
		  .y({1'b0}),
		  .fb({Net_283}),
		  .io({tmpIO_0__DIRECCION_net[0:0]}),
		  .siovref(tmpSIOVREF__DIRECCION_net),
		  .interrupt({tmpINTERRUPT_0__DIRECCION_net[0:0]}),
		  .annotation({Net_282}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__DIRECCION_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_clock_v1_0
		#(.id("43e217b1-0c5c-49c6-8c25-d0ad9bab85fb"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("100000000000"),
		  .is_direct(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("1706f26b-2ee4-4d47-987c-21ea3b7c002d"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
